import { UseCasesSection, UseCasesGridItem } from "../../components/sections/useCases.js";
...
<MaxWidthWrapper backgroundColor="#F5F6F5" gutterBottom>
  <UseCasesSection>
    <UseCasesGridItem
      image="../../images/features/eduhelx-logo.png"
      heading="EduHeLx"
    ...
    <UseCasesGridItem
      image="../../images/features/scidas-logo.svg"
      heading="SciDAS"
    ...
    <UseCasesGridItem
      image="../../images/features/restartingresearch-logo.png"
    ...
    <UseCasesGridItem
      image="../../images/features/brain-i-colors-logo.png"
      heading="BRAIN-I"
